export default {
  "header.nav.biography": "Биография",
  "header.nav.skills": "Навыки",
  "header.nav.projects": "Работы",
  "header.nav.slogan": "Слоган",
  "header.nav.contacts": "Контакты",

  "settings.settingsMenu.lang_icon.ru": "Рус",
  "settings.settingsMenu.lang_icon.en": "Англ",

  "greeting.text": "Сергей Кашко. React-разработчик.",

  "biography.header": "Биография",
  "biography.born":
    "Приветствую Вас! Меня зовут Кашко Сергей. Родился 28 августа 1986 года.",
  ...
  "skills.js.description": "Интерактивность приложений с JavaScript",
  "skills.react.description":
    "Эффективная отрисовка DOM-элементов с библиотекой React",
  "skills.redux.description":
    "Управление данными приложения с библиотекой Redux",
  ...
  "contacts.form.p_hold.phone_error":
