export default {
  "header.nav.biography": "Biography",
  "header.nav.skills": "Skills",
  "header.nav.projects": "Projects",
  "header.nav.slogan": "Slogan",
  "header.nav.contacts": "Contacts",

  "settings.settingsMenu.lang_icon.ru": "Ru",
  "settings.settingsMenu.lang_icon.en": "En",

  "greeting.text": "Sergey Kashko. React-developer.",

  "biography.header": "Biography",
  "biography.born":
    "Welcome! My name is Sergey Kashko. I was born on August 28, 1986.",
  ...
  "skills.js.description": "Applications interactivity with JavaScript",
  "skills.react.description": "Efficient rendering of DOM-elements using React",
  "skills.redux.description": "Managing application data with Redux",
  ...
  "projects.loginMessage.start": `To gain test access to the functionality of the projects, 
        please, log in to the social network or on the page `,
