...
class App extends React.Component {
  ...
  setSpaDisplayMode = (display) =>
    this.setState({ spaDisplayMode: display }, this.saveState);
      ...
      <IntlProvider locale={locale} messages={locales[locale]}>
        <ColorThemeProvider value={colorTheme}>
          <div className={styles.app + " " + styles[`theme_${colorTheme}`]}>
            {errors.length > 0 && (
              <div className={styles.errorsBox}>{errorsArr}</div>
            )}
            <Header
              ...
              <div className={styles.displaySPA}>
                <Switch>
                  ...
                  <Route
                    ...
                    path="/skills"
                    render={() => (
                      <Skills skills={skills} spaDisplayMode={spaDisplayMode} />
                    )}
                  />
                  <Route
                    exact
                  ...
                  <Route
                    exact
                    render={() => <Error404 spaDisplayMode={spaDisplayMode} />}
                  />
                </Switch>
              </div>
            ) : (
